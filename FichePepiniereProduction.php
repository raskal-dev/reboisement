...
<div class="card shadow mb-4">
                            ...
                            <div class="col-sm-12">
                              <form method="post" action="" id="insert">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-sm-3">
                                    <div class="form-group">
                                      <label>(*)Type Acteur : <a href="type_acteur.php"><span class="fa fa-pen"></span></a></label>
              ...
              <table class="table table-bordered" id="item_table">
                <thead>
                  <tr>
                    ...
                    <th>(*)Date de Semi</th>
                    <th>(*)Type Semi</th>
                    <th>(*)Nombre de Plants Produits</th>
  ...
  <div class="modal-footer">
    <a type="button" class="btn btn-danger" href="pepiniere_production.php">Retour</a>
