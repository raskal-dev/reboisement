...
group by a.nom_region');
    $surfacePrevuParRegion = getDataToLoad('select sum(surfaceTotalPrevu) totalObjectif,region from planification group by region');
   ...
   $surfacePlanifie = getDataToLoad('select round(sum(surfaceTotalPrevu)) as surfaceTotalPlanifie from planification group by anneeRebois');
            ...
            <div class="col-8 col-md-8 col-sm-8 align-left">
               ...
               <div class="col-4 col-md-4 col-sm-4  align-right ">
                  <ol class="breadcrumb float-sm-right">
                    <?php
                      echo '<li class="breadcrumb-item"><a href="../reboisement/historiquecampagne.php">Historique des campagnes</a></li>'
                                               ?>
