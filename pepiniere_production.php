...
<div class="card-body scrollable" id="acceuil">
                  ...
                  <div class="col-sm-5">
                     <form method="GET" action="">
                        <button type="submit"  class="btn btn-success btn-sm" name="reg_production"><span class="fas fa-pen-alt"> Nouveau Enregistrement</span></button>
