        ...
        <div class="scrollable">
          <table class="table table-bordered"> 
                  ...
                  <thead style="background: #E5E8EA">
                    ...
                    <h6><?php if(isset($_GET['index_annee']) && !empty($_GET['index_annee'])):?><a href="excel.php?search=parcelle&index_annee=<?=$index_annee?>" class="btn btn-success btn-sm">Export excel</a>
                    <?php endif;?>
																				</h6>
																				<h6><b>Nombre parcelle par Classe Année : <?=$index_annee?></b></h6>
																				<tr>
